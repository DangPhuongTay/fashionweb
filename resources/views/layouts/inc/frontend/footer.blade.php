    ...
    <div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="footer-underline"></div>
                        <div class="mb-2"><a href="{{ url('/collecions') }}" class="text-white">Collections</a></div>
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <p class=""> &copy; 2023 - Nom 9 Web IT - Ecommerce. All rights reserved.</p>
                    </div>
                    <div class="col-md-4">
                        <div class="social-media">
                            ...
                            @if($appSetting->youtube)
                                <a href="{{$appSetting->instagram }}" target="_blank"><i class="fa fa-youtube"></i></a>
                            @endif
                        </div>
                    </div>
                </div>
