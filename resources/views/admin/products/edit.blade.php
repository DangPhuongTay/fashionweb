                                            ...
                                            @forelse($colors as $color)
                                                <div class="col-md-3">
                                                    <div class="p-3 border mb-3">
                                                        Color:    <input type="checkbox" name="colors[{{$color->id}}]" value="{{$color->id}}" style="width:20px;height:20px;"/>
                                                        {{$color->name}}
                                                        <br>
                                                        Quantity: <input type="number" name="colorquantity[{{$color->id}}]" style="width:50px;border:1px solid;"/>
                                                    </div>
                                                </div>
                                            @empty
                                                <div class="col-md-12">
                                            ...
                                            <tr class="prod-color-tr">
                                                ...
                                                <td>
                                                    <div class="input-group mb-3" style="width:150px;">
                                                        ...
                                                        <button type="button"  class="updateProductColorBtn btn btn-primary btn-sm text-while" value="{{ $prodColor->id }}">
                                                            Update
                                                        </button>
                                                    </div>
                                                </td>
                                                <td>
                                                    <button type="button" class="deleteProductColorBtn btn btn-danger btn-sm text-while" value="{{ $prodColor->id }}">
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
