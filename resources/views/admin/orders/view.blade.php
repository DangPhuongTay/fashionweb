                ...
                <div class="card">
                    <div class="card-header">
                        <h3>My Order Details
                            ...
                            <a href="{{ url('admin/invoice/'.$order->id.'/generate') }}" class="btn btn-primary text-white btn-sm float-end mx-1">
                                Download Invoice
                            </a>
                            <a href="{{ url('admin/invoice/'.$order->id) }}" target="_blank" class="btn btn-warning text-white btn-sm float-end mx-1">
                                View Invoice
                            </a>
                        </h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <h6 class="broder p-2 text-success">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <form action="{{ url('admin/orders/'.$order->id)}}" method="POST">
                                    ...
                                    <label>Upate Your Order Status</label>
